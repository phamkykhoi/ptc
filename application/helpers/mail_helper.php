...
function send_mail_helper($mailto,$subject,$mailcontent,$listfile=array()){
    ...
    try {
        ...
        $mail->Username   = "php.thietkewebsite@gmail.com";  // GMAIL username
        $mail->Password   = "19051709";            // GMAIL password
        $mail->AddReplyTo('php.thietkewebsite@gmail.com', 'raovatlangson.vn');
        $mail->AddAddress($mailto, '0');
        $mail->SetFrom('php.thietkewebsite@gmail.com','raovatlangson.vn');
		$mail->IsHTML(true);
		$mail->CharSet  = 'UTF-8';
