...
class introduce extends Student
{
    ...
    public function index()
    {
        ...
        $data['title'] = "Danh sách bài giới thiệu";
    ...
    public function edit($id)
    {
        ...
        $data['title'] = "Sửa nội dung bài viết giới thiệu";
        $data['template'] = "introduce/edit";
        $this->load->view("layout",$data);
    }
