...
<?php if(isset($roles['service']['add']) && $roles['service']['add']): ?>
  <div id="action-links">
    <ul>
      <li id="add-prod">
        <a href="<?php echo base_url()."admin/service/add" ?>">Thêm bài viết mới</a>
      </li>
    </ul>
  </div>
<?php endif; ?>
  ...
  <table width="100%" id="tb_padding" border="1" 
    ...
    <tbody>
      <tr style="background-color:#DDD; font-weight:bold;">
        ...
        <?php if(isset($roles['service']['edit']) && $roles['service']['edit']): ?>
          <td width="45">Sửa</td>
        <?php endif; ?>

        <?php if(isset($roles['service']['del']) && $roles['service']['del']): ?>
          <td width="45">Xóa</td>
        <?php endif; ?>
      </tr>
      <?php if (isset($posts) && $posts != null): ?>
        <?php $stt = 1; foreach ($posts as $post): ?>
          <tr>
            ...
            <?php if(isset($roles['service']['edit']) && $roles['service']['edit']): ?>
              <td><a href='/admin/service/edit/<?php echo $post['id']; ?>'>Sửa</a></td>
            <?php endif; ?>

            <?php if(isset($roles['service']['del']) && $roles['service']['del']): ?>
              <td><a href='/admin/service/delete/<?php echo $post['id']; ?>'>Xóa</a></td>
            <?php endif; ?>
          </tr>
        <?php $stt++; endforeach; ?>
    <?php endif; ?>
