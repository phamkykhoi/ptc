<div class="paddings">
  <form action="<?php echo base_url()."admin/support/add/"; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="group">
      <div class="group-fields">
        <dl>
          ...
          <dd>
            <input type="text" size="80" name="sup_name" id="name" value="">
          </dd>
          <dt class="top">
            <label for="custom_collection_title">Nick yahoo</label>
          </dt>
          <dd>
            <input type="text" size="80" name="sup_yahoo" id="name" value="">
          </dd>
          <dt class="top">
            <label for="custom_collection_title">Số điện thoại</label>
          </dt>
          <dd>
            <input type="text" size="80" name="sup_phone" id="name" value="">
          </dd>
          <dt class="top">
            <label for="custom_collection_title">Nick skype</label>
          </dt>
          <dd>
            <input type="text" size="80" name="sup_sky" id="name" value="">
          </dd>
          <dt class="top">
            <label for="custom_collection_title">Email</label>
          </dt>
          <dd>
            <input type="text" size="80" name="sup_email" id="name" value="">
          </dd>
